import { Car, TrendingUp, Plane, UserRound, Rocket, Handshake } from 'lucide-react'
            ...
            <div id="colaboraciones" className="scroll-mt-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.2fr] gap-8 lg:gap-12 items-start">
                    ...
                    <div>
                        ...
                        <p className="text-white/70 leading-relaxed mt-6 max-w-xl">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-8">
                            {ACTIVITIES.map(({ icon: Icon, title, text }) => (
                                ...
                                >
                                    ...
                                    <p className="text-[11px] text-white/55 leading-relaxed transition-colors duration-300 group-hover:text-white/75">
                                        {text}
                                    </p>
                                </div>
                            ))}
